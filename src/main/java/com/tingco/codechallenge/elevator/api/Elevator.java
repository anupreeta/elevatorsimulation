...
interface Elevator {
    ...
    /**
     * Move the elevator 'n' floors up, helpful in tall buildings where some elevators handle only even or odd floor numbers
     */
    void moveUp(int floors);

    /**
     * Move the elevator 'n' floors down, helpful in tall buildings where some elevators handle only even or odd floor numbers
     */
    void moveDown(int floors);
